...
def test_semantic_first_notebook_is_valid_and_output_free() -> None:
    ...
    assert (
        'EXPECTED_PROJECT_COMMIT = "3c04853107e4a01ecc83e8a8fcad331be6984b6b"' in preflight_source
    )
    ...
    assert 'EXPECTED_PROJECT_COMMIT = "3c04853107e4a01ecc83e8a8fcad331be6984b6b"' in source
