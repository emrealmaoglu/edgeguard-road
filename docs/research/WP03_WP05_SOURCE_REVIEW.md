...
| Fishyscapes Lost & Found validation | `ood_development` | Conditional, public-development foundation | Annotation license recorded; underlying image terms and access require separate human approval. | Pixel-level AP and FPR95 development evaluation after manual data preparation and manifest approval. | No threshold selection, calibration, redistribution, or final benchmark claim. |
