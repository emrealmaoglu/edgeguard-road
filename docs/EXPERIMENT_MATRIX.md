...
| Smoke | 5 models, 2 scientific sources | 50 steps/model | Finite train/val, checkpoint reload |
| Pilot | 5 models, 2 scientific sources | 2,000 steps/model | Domain/select and rare-class metrics |
| Screening | models passing pilot | 6,000 steps/model | Domain-macro mIoU and early ONNX result |
...
| Final | scientific + edge candidates | at most 40,000 steps | Convergence, checkpoint and provenance |
